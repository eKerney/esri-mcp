...
async def main():
    ...
    try:
        async with Client(http_server_url) as client:
            ...
            print("Calling query_layer tool for usgs-gauges in Michigan...")
            ...
            if "features" in usgs_data:
                ...
                with open("/Users/erickerney/dev/ai/esri-mcp/michigan_usgs.geojson", "w") as f:
                    json.dump(geojson, f, indent=2)
                
                print(f"GeoJSON file created: michigan_usgs.geojson with {len(geojson_features)} features")
            else:
