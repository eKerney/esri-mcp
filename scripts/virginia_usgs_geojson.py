...
async def main():
    ...
    try:
        async with Client(http_server_url) as client:
            ...
            print("Calling query_layer tool for usgs-gauges in Virginia...")
            ...
            if "features" in usgs_data:
                ...
                geojson_path = "/Users/erickerney/dev/ai/esri-mcp/virginia_usgs.geojson"
                with open(geojson_path, "w") as f:
                    json.dump(geojson, f, indent=2)
                
                print(f"GeoJSON file created: virginia_usgs.geojson with {len(geojson_features)} features")
